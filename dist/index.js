...
},{"process":"../node_modules/process/browser.js"}],"genericActions.ts":[function(require,module,exports) {
"use strict";
...
var genericActions_1 = require("./genericActions");

exports.ADD_VALUE = 'ADD_VALUE';
exports.ADD_VALUES = 'ADD_VALUES';
...
exports.Actions = {
  addValue: function addValue(value) {
    return genericActions_1.actionCreator(exports.ADD_VALUE, value);
  },
  addValues: function addValues() {
    ...
    return genericActions_1.actionCreator(exports.ADD_VALUES, values);
  },
  clearValues: function clearValues() {
    return genericActions_1.actionCreator(exports.CLEAR_VALUES);
  }
};
},{"./genericActions":"genericActions.ts"}],"store.ts":[function(require,module,exports) {
"use strict";
...
exports.reducer = function (state, action) {
  return immer_1.produce(state, function (draft) {
    ...
    switch (action.type) {
      case actions_1.ADD_VALUE:
        draft.values.push(action.payload);
        break;

      case actions_1.CLEAR_VALUES:
        draft.values = [];
        break;

      case actions_1.ADD_VALUES:
        (_a = draft.values).push.apply(_a, action.payload);

        break;
    }
  });
};
},{"immer":"../node_modules/immer/dist/immer.module.js","./actions":"actions.ts"}],"state.ts":[function(require,module,exports) {
"use strict";
...
var finalState = [actions_1.Actions.addValue(20), actions_1.Actions.addValue(40), actions_1.Actions.clearValues(), actions_1.Actions.addValue(50), actions_1.Actions.addValue(20), actions_1.Actions.addValues(20, 50, 90, 20)].reduce(store_1.reducer, state_1.initialState);
console.log(finalState.values);
},{"./store":"store.ts","./state":"state.ts","./actions":"actions.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
